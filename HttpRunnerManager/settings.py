...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'NAME': 'HttpRequestManage',  # 新建数据库名
            'USER': 'root',  # 数据库登录名
            'PASSWORD': '306359211xxx',  # 数据库登录密码
            'HOST': 'cdb-lsyn7ojl.gz.tencentcdb.com',  # 数据库所在服务器ip地址
            'PORT': '10078',  # 监听端口 默认3306即可
        }
    }
    STATICFILES_DIRS = (
...
EMAIL_SEND_USERNAME = 'k568898699@163.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = '306359211xxx'     # 邮箱密码
